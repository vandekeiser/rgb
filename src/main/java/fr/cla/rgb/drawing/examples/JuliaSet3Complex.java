...
public class JuliaSet3Complex extends WholeDrawing {

    private int minDivergingIteration, maxDivergingIteration;

    public JuliaSet3Complex(int size) {
        super(size);
    }

    public static void main(String... args) throws Exception {
        JuliaSet3Complex js = new JuliaSet3Complex(1024);
